...
module.exports = (jsFileInfo, scssFileInfo, indexFileInfo) => {
    ...
    output.on('close', function () {
        ...
        fs.unlinkSync(indexFileInfo.fileName);
    });
    ...
    archive.append(fs.createReadStream(indexFileInfo.fileName), { name: `index.js` });
    archive.finalize();
}